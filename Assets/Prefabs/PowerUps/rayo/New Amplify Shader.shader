...
Shader "New Amplify Shader"
{
	Properties
	{
		_heightmapshieldStar("heightmapshieldStar", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _heightmapshieldStar;
		uniform float4 _heightmapshieldStar_ST;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float2 uv_heightmapshieldStar = i.uv_texcoord * _heightmapshieldStar_ST.xy + _heightmapshieldStar_ST.zw;
			o.Albedo = tex2D( _heightmapshieldStar, uv_heightmapshieldStar ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=16301
-17;343;1471;279;2282.628;133.0486;2.128104;True;False
Node;AmplifyShaderEditor.SamplerNode;1;-678.6567,69.97873;Float;True;Property;_heightmapshieldStar;heightmapshieldStar;0;0;Create;True;0;0;False;0;df7ec1fb281cc1149b0876b431cd5280;df7ec1fb281cc1149b0876b431cd5280;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4AA0133752564660ED61A44531C5DF2767122467